...
namespace UnityStandardAssets.Characters.FirstPerson {
    public class FirstPersonController : MonoBehaviour, IDisposable {
        ...
        public Action<Vector2, bool, bool>MoveEvent;
        ...
        public void OnJump() { if (!m_Jump) { m_Jump = true; } }
        public void SetInputAxis(Vector2 inputAxis) { m_Input = inputAxis; } 
        ...
        public void OnFixedUpdate() {
            ...
            MoveEvent?.Invoke(m_Input, m_IsWalking, isCrouching);
